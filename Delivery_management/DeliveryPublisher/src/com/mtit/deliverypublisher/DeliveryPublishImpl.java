...
//		String userInputs = getUserInput();
    	...
    	//Display bill
    	System.out.println("\n--------------------------------------");
    	System.out.println("\tDelivery Invoice");
    	System.out.println("--------------------------------------");
    	System.out.println("\tDistance-based delivery fee : "  +distanceRate);
    	System.out.println("\tCash On Delivery charges : "  +codCharges);
	...
	public void checkOffers() {
	    ...
	    System.out.print("2. Enter total Number of Orders for the Month : ");
